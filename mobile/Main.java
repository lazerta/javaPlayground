...
public class Main {
    ...
    private static Phone phone= new Phone("123442");
        ...
        while(!quit) {
            ...
            switch (action) {
                ...
                case 6:
                    ...
                    break;
                 default:
                	 System.out.println("read the instruction");
            }
    ...
    private static void addNewContact() {
        ...
        if(phone.add(newContact)) {
            System.out.println("New contact added: name = " + newContact);
        } else {
    ...
    private static void removeContact() {
        ...
        if(phone.remove(existingContactRecord)) {
